...
final class TotalType extends AbstractEnum
{
    ...
    private static array $blurbs = [
        ...
        self::TYPE_ENDORSEMENT => 'Donors who gave previously to an endorser\'s campaign committee or leadership PAC',
        self::TYPE_NON_ENDORSEMENT => 'Donors who did not give previously to an endorser\'s campaign committee or'
            . ' leadership PAC',
